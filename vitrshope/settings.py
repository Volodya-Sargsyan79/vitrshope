"""
Django settings for vitrshope project.
...
SECRET_KEY = 'django-insecure-sk@_^=83^9n@r2!l1upqbkxobmfrb1e*odnr#)r2w%v4p9l*=a'
...
WSGI_APPLICATION = 'vitrshope.wsgi.application'
